package com.aryandevhub.raft.storage;

import com.aryandevhub.raft.RaftOptions;
import com.aryandevhub.raft.util.RaftFileUtils;
...
public class SegmentedLog {
     ...
     * 包括commitIndex， fix bug: https://github.com/aryandevhub/raft-java/issues/19
     * @param currentTerm
     * @param votedFor
     * @param firstLogIndex
     * @param commitIndex
